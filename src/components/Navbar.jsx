...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/70 border-b border-[#00B7B5]/10 
    shadow-sm">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="h-20 flex items-center justify-between">
          {/* LOGO */}
          <Link href="/" className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#005461] to-[#00B7B5] 
          ...
          <div className="hidden lg:flex items-center gap-4 relative">
            ...
            <button
              ...
              className="w-11 h-11 rounded-full border border-[#00B7B5]/20 flex items-center 
              justify-center text-[#005461] hover:bg-[#00B7B5] hover:text-white transition-all 
              duration-300"
            >
            ...
            <div className="relative">
              <button
                ...
                className="w-11 h-11 rounded-full bg-gradient-to-r from-[#018790] 
                to-[#00B7B5] flex items-center justify-center text-white text-xl shadow-md"
              >
                <FaUserCircle />
              </button>

              {profileOpen && (
                <div className="absolute right-0 top-14 w-52 bg-white rounded-2xl shadow-xl 
                border border-gray-100 p-3">
                  <div className="flex flex-col gap-2">
                    <Link
                      href="/profile"
                      className="px-4 py-2 rounded-xl hover:bg-[#F4F4F4] transition-all duration-300 
                      text-[#005461]"
                    >
                      Profile
                    </Link>

                    <button className="text-left px-4 py-2 rounded-xl hover:bg-[#F4F4F4] 
