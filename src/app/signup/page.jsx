...
const SignupPage = () => {
    ...
    return (
        <section className="min-h-screen bg-[#F4F4F4] flex items-center justify-center px-4 py-10">
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[40px] overflow-hidden border border-[#00B7B5]/10 shadow-xl">
                {/* LEFT SIDE */}
                ...
                <div className="p-6 md:p-10 lg:p-14 flex items-center">
                    <div className="w-full">
                        ...
                        {/* GOOGLE */}
                        <button className="w-full h-14 rounded-2xl border border-[#00B7B5]/20 bg-white hover:bg-[#00B7B5]/5 transition-all duration-300 font-medium text-[#005461]">
